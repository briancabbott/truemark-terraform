...
class HCLGenerator(object):
    def __init__(self, hashis: list[RegisteredHashiObj]) -> None:
        ...
        # print("self.providers: ", self.providers)
        # print("self.hashi_objects: ", self.hashi_objects)
    ...
    def generate_hcl_header(self) -> str:
        ...
        #      }
        #    }
        # Note: this isnt part of the PyType Generation objects because it doesnt reside in a dynamically available location, its a header generation sequence.
        header_text = ""
